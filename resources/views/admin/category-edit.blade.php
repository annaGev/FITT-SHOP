       ...
       <div class="wg-box">
           <form class="form-new-product form-style-1" action="{{ route('admin.category.update', ['id'=>$category->id]) }}" method="POST"
               ...
               <fieldset class="name">
                   ...
                   <input class="flex-grow" type="text" placeholder="Введите название категории" name="name"
               ...
               <fieldset class="name">
                   ...
                   <input class="flex-grow" type="text" placeholder="Введите ЧПУ категории" name="slug"
