                        ...
                        <div class="wg-chart-default mb-20">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap14">
                                    ...
                                    <div>
                                        <div class="body-text mb-2">Всего заказов</div>
                        ...
                        <div class="wg-chart-default mb-20">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap14">
                                    ...
                                    <div>
                                        <div class="body-text mb-2">Ожидающие заказы</div>
                        ...
                        <div class="wg-chart-default">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap14">
                                    ...
                                    <div>
                                        <div class="body-text mb-2">Сумма ожидающих заказов</div>
                        ...
                        <div class="wg-chart-default mb-20">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap14">
                                    ...
                                    <div>
                                        <div class="body-text mb-2">Сумма доставленных заказов</div>
                        ...
                        <div class="wg-chart-default mb-20">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap14">
                                    ...
                                    <div>
                                        <div class="body-text mb-2">Отмененные заказы</div>
                    ...
                    <div class="flex flex-wrap gap40">
                        ...
                        <div>
                            <div class="mb-2">
                                <div class="block-legend">
                                    ...
                                    <div class="text-tiny">Ожидающие</div>
                                </div>
                            </div>
                            <div class="flex items-center gap10">
                        ...
                        <div>
                            <div class="mb-2">
                                <div class="block-legend">
                                    <div class="dot t2"></div>
                                    <div class="text-tiny">Отмененные</div>
                                </div>
                            </div>
                            <div class="flex items-center gap10">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="dropdown default">
                            <a class="btn btn-secondary dropdown-toggle" href="{{ route('admin.orders') }}">
                                <span class="view-all">Показать все</span>
                            </a>
                        </div>
                    </div>
