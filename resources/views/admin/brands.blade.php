...
<div class="main-content-wrap">
    ...
    <div class="flex items-center flex-wrap justify-between gap20 mb-27">
        ...
        <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
            ...
            <li><div class="text-tiny">Бренды</div></li>
        </ul>
    </div>
    ...
    <div class="wg-box">
        ...
        <div class="table-top-bar">
            ...
            <a class="tf-button style-1 w208" href="{{ route('admin.add.brand') }}">
                <i class="icon-plus"></i>Добавить бренд
            </a>
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="pname">
                                    ...
                                    <div class="name">
                                        <a href="{{ route('admin.brand.edit', $brand->id) }}" class="body-title-2">
                                            {{ $brand->name }}
                                        </a>
                                    </div>
                                </div>
                            </td>
                            <td><span class="mono">{{ $brand->slug }}</span></td>
                            <td class="text-center">
                                <span class="qty-badge">{{ $brand->products()->count() }}</span>
                            </td>
                            <td class="text-center">
                        ...
                        @empty
                        <tr class="empty-row">
                            <td colspan="4">Бренды не найдены</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
