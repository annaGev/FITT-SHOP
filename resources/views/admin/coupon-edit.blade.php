...
<li>
    <div class="text-tiny">Редактировать купон</div>
</li>
</ul>
</div>
<div class="wg-box">
...
<fieldset class="category">
    ...
    <div class="select flex-grow">
        <select class="" name="type">
            ...
            <option value="fixed" {{ $coupon->type == 'fixed' ? 'selected' : '' }}>Фиксированная</option>
            <option value="percent" {{ $coupon->type == 'percent' ? 'selected' : '' }}>Процентная</option>
        </select>
    </div>
</fieldset>
@error('type') <span class="alert alert-danger text-center">{{$message}}</span> @enderror
<fieldset class="name">
    <div class="body-title">Сумма <span class="tf-color-1">*</span></div>
...
<fieldset class="name">
    <div class="body-title">Сумма корзины <span class="tf-color-1">*</span></div>
...
<fieldset class="name">
    <div class="body-title">Срок Годности <span class="tf-color-1">*</span></div>
...
@error('expity_date') <span class="alert alert-danger text-center">{{$message}}</span> @enderror
<div class="bot">
    <div></div>
