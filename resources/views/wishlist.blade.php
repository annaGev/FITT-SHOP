                    ...
                    <div class="cart-table__wrapper">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <form
                                                        ...
                                                        method="POST">
                                                        @csrf
                                                        <button type="submit" class="btn btn-sm btn-warning" style="border-radius: 7px;">В
                                                            корзину</button>
                                                    </form>
                                                </div>
                                                <div class="col-6">
                        ...
                        <div class="cart-table-footer">
                            <form action="{{ route('wishlist.items.clear') }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-light" style="border-radius: 7px;">ОЧИСТИТЬ ИЗБРАННОЕ</button>
                            </form>
                        </div>
                    </div>
                @else
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <a href="{{ route('shop.index') }}" class="btn btn-info" style="border-radius: 7px;">В магазин</a>
                        </div>
                    </div>
                @endif
