                ...
                <div class="section-menu-left">
                    ...
                    <div class="center">
                        <div class="center-item">
                            <div class="center-heading">Главная панель</div>
                            <ul class="menu-list">
                                <li class="menu-item">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{ route('admin.add.category') }}" class="">
                                                <div class="text">Новая категория</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        {{-- <li class="sub-menu-item">
                                            <a href="order-tracking.html" class="">
                                                <div class="text">Отслеживание заказов</div>
                                            </a>
                                        </li> --}}
                                    </ul>
                                </li>
                ...
                <div class="section-content-right">
                    ...
                    <div class="header-dashboard">
                        <div class="wrap">
                            <div class="header-left">
                                ...
                                {{--  <img class="" id="logo_header_mobile" alt="FITT"
                                    src="{{ asset('assets/images/logo.png') }}" style="width:20px; height:auto;"> --}}
                                        ...
                                        {{-- <ul class="dropdown-menu dropdown-menu-end has-content"
                                            ...
                                            <li>
                                                <div class="message-item item-1">
                                                    ...
                                                    <div>
                                                        <div class="body-title-2">Доступна скидка</div>
                                            ...
                                            <li>
                                                <div class="message-item item-2">
                                                    ...
                                                    <div>
                                                        <div class="body-title-2">Аккаунт подтвержден</div>
                                            ...
                                            <li>
                                                <div class="message-item item-3">
                                                    ...
                                                    <div>
                                                        <div class="body-title-2">Заказ успешно отправлен</div>
                                            ...
                                            <li>
                                                <div class="message-item item-4">
                                                    ...
                                                    <div>
                                                        <div class="body-title-2">Ожидающий заказ: <span>ID
                                                                305830</span>
                                                        </div>
                                            ...
                                            <li><a href="#" class="tf-button w-full">Показать все</a></li>
                                        </ul> --}}
                                    </div>
                                </div>
                                        ...
                                        <button class="btn btn-secondary dropdown-toggle" type="button"
                                            ...
                                            <span class="header-user wg-user">
                                                ...
                                                <span class="flex flex-column">
                                                    <span
                                                        class="body-title mb-2">{{ Auth::user()->name ?? 'Администратор' }}</span>
                                                    <span class="text-tiny">Админ</span>
                                                </span>
                                            </span>
                                        </button>
                                        <ul class="dropdown-menu dropdown-menu-end has-content"
                                            ...
                                            <li>
                                                <a href="#" class="user-item">
                                                    ...
                                                    <div class="body-title-2">Доска задач</div>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#" class="user-item">
                    ...
                    <div class="main-content">
                        ...
                        <div class="bottom-page">
                            <div class="body-text">Copyright © 2026 FITT</div>
                        </div>
                    </div>
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $.each(data, function(index, item) {
                                ...
                                let link = url.replace('product_id', item.id);

                                $("#box-content-search").append(`
                        <li>
                          <ul>
                            <li class = "product-item no-bg">
