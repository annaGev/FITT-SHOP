      ...
      <ul class="nav nav-tabs mb-5" id="login_register" role="tablist">
        <li class="nav-item" role="presentation">
          <a class="nav-link nav-link_underscore active" id="login-tab" data-bs-toggle="tab" href="#tab-item-login"
            role="tab" aria-controls="tab-item-login" aria-selected="true">Войти</a>
        </li>
      </ul>
            ...
            <form method="POST" action="{{ route('login') }}" name="login-form" class="needs-validation" novalidate="">
              ...
              <div class="form-floating mb-3">
                <input class="form-control form-control_gray @error('email') is-invalid @enderror " name="email" value="{{ old('email') }}" required="" autocomplete="email"
                  autofocus="" style="border-radius: 7px;">
              ...
              <div class="form-floating mb-3">
                <input id="password" type="password" class="form-control form-control_gray @error('password') is-invalid @enderror " name="password" required=""
                  autocomplete="current-password" style="border-radius: 7px;">
              ...
              <button class="btn btn-primary w-100 text-uppercase" type="submit" style="border-radius: 7px;">Войти</button>

              <div class="customer-option mt-4 text-center">
                <span class="text-secondary">Нет аккаунта ?</span>
                <a href="{{ route('register') }}" class="btn-text js-show-register">Создать Аккаунт</a>
              </div>
            </form>
          </div>
        </div>
